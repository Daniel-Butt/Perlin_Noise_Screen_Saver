...
public class GraphicsConsole extends JFrame implements MouseListener, MouseMotionListener, MouseWheelListener, ComponentListener {
	...
	public boolean mouseButton[] = { false, false, false };
	public int mouseX, mouseY;
	public int mouseClick = 0, mouseWheelRotation = 0, mouseWheelUnitsToScroll = 0;
	public boolean mouseDrag = false;
	public boolean mouseTracking = false;
	public boolean mouseWasMoved = false;
	public boolean keyboardInput = false;
...
<pre>
	...
	*/
	...
	private void makeGUI (int width, int height, int fontSize, String title) {
		...
		//this.setLocation(0,0); //centre the window in the display
		this.pack();
